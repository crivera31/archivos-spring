...
import com.sprinboot.servicios.app.empresa.villasol.dao.RegistroDocumentosDao;
...
import com.sprinboot.servicios.app.empresa.villasol.service.IPlesService;
		...
		MsgxDto msgx = new MsgxDto();
		 //Columna 1 Periodo , Obligatorio
		      ...
		      //columna 14 FVENCI
		        ...
		        if (funciones.getTrim(voucher.getCodPlan()).compareTo(funciones.getTrim(codPlanParametroCompras))==0 || funciones.getTrim(voucher.getCodPlan()).compareTo(funciones.getTrim(codPlanParametroVentas))==0) {
