...
public class Funciones {
	...
	* @Param (String) texto 
	...
	/* Funcion para cortar cadena desde el final si este excede  el max
	 * @Param (int) Maximo
	 * @Param (String) cadena
	 * return 
	 * */
	...
	/* Funcion obtener el plan contable ordenado
	 * @Param (List) PLan contable
	 * return el plan contable ordenado
	 * */
	public List<PlanCuenta> getOrdenarPlanContable(List<PlanCuenta> list){
		Comparator<PlanCuenta> comparador = (o1, o2) -> o1.getCodCuenta().trim().compareTo(o2.getCodCuenta().trim());
