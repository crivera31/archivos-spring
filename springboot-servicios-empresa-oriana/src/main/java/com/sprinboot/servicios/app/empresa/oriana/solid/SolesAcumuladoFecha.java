...
@Service("SolesAcumuladoFecha")
public class SolesAcumuladoFecha implements OpcionReporte{
Logger logger = LoggerFactory.getLogger(SolesMensualFecha.class);
	...
	@Autowired
	public SolesAcumuladoFecha(RegistroLibrosDao dao, RegistrosSistemaServiceInterface service) {
		this.dao = dao;
	...
	public RegistrosCabRest proceso(Integer idperiodo, String anio, Integer codmes , String codLibro, String codPlanParametro) {
		List<RegistroLibros> lstRegLibros = dao.listarRegistroSistemaAcumuladoFecha(codmes, anio, codLibro, codPlanParametro);
