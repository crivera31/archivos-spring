...
import com.sprinboot.servicios.app.empresa.constructores.service.ILibroMayorService;
import com.sprinboot.servicios.app.empresa.constructores.service.RegistroLibrosServiceInterface;
import com.sprinboot.servicios.app.empresa.constructores.service.ReporteLIbroDiarioService;
...
public class ReportesSunatController {
    ...
    public ResponseEntity<?> registroComprasPdf(@PathVariable Integer idperiodo, @PathVariable String anio,@PathVariable Integer codmes,@PathVariable String codlibro,@PathVariable String codCtaParametro,@PathVariable String codClasificacion,@PathVariable String nommes) {
		...
		try {
		 ...
		 parameters.put("constructora", "CONSORCIO LOS CONSTRUCTORES.");
		 parameters.put("direccion", "   ");
		 parameters.put("ejercicio", "EJERCICIO 2020");
		 parameters.put("ruc", "20606605413");
