package com.sprinboot.servicios.app.empresa.constructores.funciones;
...
public class FileService {
	...
	private static final String FILE_DIRECTORY = "/var/files/";  //paralinux
	
	//private static final String FILE_DIRECTORY = "C:/Users/Usuario/Documents/documentos spring/";  //parawindows
	/**
	...
	public Resource getClassPathFile(String filename, HttpServletResponse response , String tipoArchivo) {
		return getResource(filename, response, ResourceType.CLASSPATH,tipoArchivo);
	}
